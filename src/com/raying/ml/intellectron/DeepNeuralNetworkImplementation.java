...
package com.raying.ml.intellectron;
...
import com.raying.ml.intellectron.neuralnetworks.DeepNeuralNetwork;
import com.raying.ml.intellectron.util.FileIO;
...
public class DeepNeuralNetworkImplementation {
	...
	public void train2(double[][] inputs, double[][] outputs){
		for(int i=0; i<inputs.length; i++){
			System.out.println("Progress:" + (float)(i*100)/inputs.length + "\t inputs.length:" + inputs.length);
