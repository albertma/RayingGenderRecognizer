...
package com.raying.ml.deepGenderRecognizer;

import com.raying.ml.egami.matrix.Matrix;
import com.raying.ml.egami.matrix.MatrixUtilities;
import com.raying.ml.intellectron.DeepNeuralNetworkImplementation;
import com.raying.ml.intellectron.dataPrepare.DataPreparer;

public class DeepGenderRecognizer {
	public static void main(String[] args) throws Exception {
		System.out.println("OPERATION STARTED!!!");
		String workspace = "/Users/albertma/workspace/sourcecodes/startup/java/GenderRecognizer/";
...
//				numbersOfNeuronsInLayers, 0.01, matrixHeight*matrixWidth);
		...
		DeepNeuralNetworkImplementation neuralNetworkImplementation = new DeepNeuralNetworkImplementation(
				workspace+"src/res/knowledge200.xml");
		/**/
